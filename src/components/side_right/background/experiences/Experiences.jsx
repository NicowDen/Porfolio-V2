    ...
    <div className={mc.container}>
      ...
      <div className={mc.sub_container}>
        ...
        <div className={mc.experience}>
          ...
          <p>
            Ma première expérience professionnelle. C'était un travail difficile
            mais très formateur. Fait insolite : il m'aura permis de connaître
            sur le bout des doigts tous les{" "}
            <span className="highlight">codes postaux</span>. Et aujourd'hui
            encore, je suis capable de tous les citer en un éclair ! C'est faux,
            le temps est passé et je n'en connais plus le quart...
          </p>
        </div>
      </div>
    </div>
